...
def apriori(listi,threshold):
    ...
    print listToLatexTabel(["ABE","ABC"],"HEJ")
...
def pruner(dicti,threshold):
    ...
    elemPruned = []
    print "\nC before Pruning"
    dictToLatexTabel(dicti, "C" +str(len(dicti.items()[0][0]))+ " before prune")
...
def cN(dicti):
    ...
    for i in range(len(startList)):
        ...
        while j < len(startList):
            ...
            j = j+1
    listToLatexTabel(resList,"C" + str(k+1))
